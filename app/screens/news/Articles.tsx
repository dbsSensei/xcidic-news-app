...
export default function Articles(props: { navigation: any; }) {
    ...
    const newsReducer = useSelector(({newsReducer}:any) => newsReducer);
...
Articles.navigationOptions = ({navigation}:any) => {
    return {
