...
import PanelItem, {dividerStyle} from '../../components/NewsApp/PanelItem'
...
export default function Search(props: { navigation: { goBack?: any; navigate?: any; }; }) {
    ...
    const [cancelToken, setCancelToken]:any = useState('');

    //==================================================================================================

    //2 - HANDLE QUERY CHANGE
    const handleQueryChange = (text: React.SetStateAction<string>) => {
        setSearchText(text);
        executeSearch(text);
    };
            ...
            <View style={{flex: 1}}>
                {
                    (isSearching) ?
                        ...
                        <FlatList
                            ...
                            keyExtractor={(item:any, index) => `Search_${item.title}`}
